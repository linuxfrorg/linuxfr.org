...
protected
  ...
  def seo_filter
    ...
    @description   = "L’actualité du logiciel libre et de GNU/Linux, sur un site francophone contributif géré par une équipe bénévole par et pour des libristes enthousiastes"
    @feeds         = {}
